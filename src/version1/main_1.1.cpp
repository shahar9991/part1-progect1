...
//     std::function<size_t(const std::string&)> hashFunction2 = nullptr;
...
int main() {
    ...
    // Create an instance of HashGenerator
    HashGenerator hashGenerator;

    // Get the hash functions based on user input
    std::vector<HashGenerator::HashFunction> hashFunctions = hashGenerator.getHashFunctions(args);

    // Initialize BloomFilter using user inputs and hash functions
